...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow border-top border-5 border-primary sticky-top p-0">
    <a href="{{ route('index') }}" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
        <img src="img/Logo2.png" class="logo" height="110" width="165" style="background-color: white;">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            @if(Route::is('index'))
                ...
                <a href="{{ route('service') }}" class="nav-item nav-link">Keunggulan</a>
            ...
            @elseif(Route::is('service'))
                ...
                <a href="{{ route('service') }}" class="nav-item nav-link active">Keunggulan</a>
                <a href="{{ route('product') }}" class="nav-item nav-link">Produk</a>
                <a href="{{ route('about') }}" class="nav-item nav-link">Tentang Kami</a>
